...
public abstract class TrainingQueries {
	...
	public static final String GET_KEYWORD_FOR_QUESTIONS = "SELECT B.EXAM_QUES_ID, A.KEYWORD, A.QUANTITIES, A.SYMBOLS, A.UNITS, A.FORMULAE, A.DATA, A.KEYWORD_DESC, A.KEYWORD_IMAGE" +
