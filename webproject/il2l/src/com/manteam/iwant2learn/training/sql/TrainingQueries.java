...
public abstract class TrainingQueries {
	...
	public static final String RETRIEVE_QUESTIONS_SUBMOD = "SELECT D.SUBJECT_NAME, C.MODULE_NAME, B.SUBMODULE_NAME, B.SUBMODULE_DESC, A.EXAM_QUESTIONS_ID, A.QUESTION, A.QUES_IMG_NAME, A.QUES_IMG, A.QNO_YEAR_MARKS, "
	...
	public static final String GET_KEYWORD_FOR_QUESTIONS = "SELECT A.SYB_KEYWORD_ID, B.EXAM_QUES_ID, A.KEYWORD, A.QUANTITIES, A.SYMBOLS, A.UNITS, A.FORMULAE, A.DATA, A.KEYWORD_DESC, A.KEYWORD_IMAGE" +
			" FROM syb_keyword A, exam_ques_keyword_map B" +
